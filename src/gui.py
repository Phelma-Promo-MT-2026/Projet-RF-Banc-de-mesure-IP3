...
from src.pluto_interface import *
from src.utils import *
from src.error_manager import *
...
class main_window(tk.Tk):
    ...
    def send(self):
        ...
        self.f_rf = f_rf
        self.pe = pe
        return_code = self.test_pluto.send_waveform(int(f_rf), self.delta_f, self.fs_pluto, self.n_sample, int(pe), I_enable, Q_enable)
        if(return_code == 1):
